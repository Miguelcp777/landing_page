...
- **INV-PROD-004** — Anything presented as AI-generated must be labelled as such. The
  chat panel says it is an AI assistant and speaks about Miguel in the third person.

## Non-goals

- A blog or a general-purpose personal site.
- Impersonating Miguel. The assistant represents him; it does not speak as him.
